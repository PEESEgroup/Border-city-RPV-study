...
city_solar_data_checked = {
    # ======================
    # US-MX BORDER
    # ======================
    "San Diego": {
        "cost_per_watt": 2.6,
        "capex_reduction": 0.20,
        "elec_rate": 0.39,
        "export_rate": 0.03,
        "pv_yield_kwh_per_kw_year": 1650,
...
def main() -> None:
    ...
    output_path = Path(__file__).with_name("economic_analysis_results.csv")
